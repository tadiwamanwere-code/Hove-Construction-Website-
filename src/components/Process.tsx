            ...
            {PROCESS_STEPS.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 w-1.5 h-1.5 bg-orange-500" />
                  )}
                </button>
              );
            })}
                ...
                >
                  <div>
                    ...
                    <div className="flex items-center justify-between border-b border-white/5 pb-4 mb-6">
                      <div className="flex items-center gap-3">
                        <div className="p-2.5 bg-orange-500/10 rounded-none">
                  ...
                  <div className="border-t border-white/5 pt-6 mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-white/5 hover:bg-orange-600 text-white font-mono text-[10px] tracking-widest uppercase transition-colors cursor-pointer"
                    >
                      NEXT PHASE →
                    </button>
                  </div>
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <span className={`w-2 h-2 rounded-full transition-colors duration-300 ${
                  activeStep === idx ? 'bg-orange-500 scale-110' : 'bg-zinc-800 group-hover:bg-gray-600'
                }`} />

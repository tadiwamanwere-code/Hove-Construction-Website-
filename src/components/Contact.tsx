...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-[#0B0C0E] text-white overflow-hidden relative">
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-orange-600/5 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="max-w-2xl mb-16 md:mb-24">
          <div className="flex items-center gap-2 mb-4">
            <span className="h-[1px] w-6 bg-orange-500"></span>
            <span className="text-xs font-mono tracking-[0.25em] text-orange-500 uppercase font-semibold">
              GET IN TOUCH
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            >
              <div className="absolute inset-0 opacity-15 flex flex-col justify-between pointer-events-none p-2 font-mono text-[8px] text-gray-500">
                <div className="flex justify-between">
                  <span>LAT: 17.8249° S</span>
                  <span>LNG: 31.0530° E</span>
                </div>
                <div className="flex justify-between">
                  <span>GRID SEC: H-2</span>
                  <span>ELEV: 4890 FT</span>
                </div>
              </div>
              ...
              <div className="absolute left-[55%] top-[45%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10">
                <span className="absolute w-6 h-6 bg-orange-600/30 rounded-full animate-ping pointer-events-none"></span>
                <span className="absolute w-3 h-3 bg-orange-500 rounded-full border border-white"></span>
              ...
              <div className="relative z-10 flex justify-between items-end border-t border-white/5 pt-3">
                <p className="text-[10px] font-sans text-gray-400 font-light">
                  42 Samora Machel Avenue, Harare
                </p>
          ...
          <div className="lg:col-span-7 bg-[#121317] border border-white/5 p-8 md:p-12 shadow-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-3 h-3 bg-orange-600" />
            ...
            <AnimatePresence mode="wait">
              {!isSuccess ? (
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-white/[0.02] border border-white/10 focus:border-orange-500 px-4 py-3 text-sm font-sans text-white focus:outline-none transition-colors"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full bg-[#121317] border border-white/10 focus:border-orange-500 px-4 py-3 text-sm font-sans text-white focus:outline-none transition-colors cursor-pointer"
                      >
                        ...
                        <button
                          ...
                          className={`py-3 text-xs font-mono tracking-wider uppercase transition-all duration-300 cursor-pointer ${
                            formState.budget === range
                              ? 'bg-orange-600/20 border-orange-500 text-orange-500 font-bold border'
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full bg-white/[0.02] border border-white/10 focus:border-orange-500 px-4 py-3 text-sm font-sans text-white focus:outline-none transition-colors resize-none"
                  ...
                  <AnimatePresence>
                    {validationError && (
                      <motion.div
                        ...
                        className="p-4 bg-orange-950/40 border border-orange-500/50 flex items-center gap-3 text-orange-400 text-xs font-mono"
                      >
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-orange-600 hover:bg-orange-500 disabled:bg-orange-950 disabled:text-gray-500 text-white font-mono text-xs tracking-widest uppercase transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-orange-500/10 border border-orange-500 flex items-center justify-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs font-mono text-gray-500 uppercase tracking-widest">
                      REFERENCE CODE: HOVE-RECV-{(Math.random() * 10000).toFixed(0)}
                    </p>
                  </div>
                  <p className="text-sm font-sans text-gray-400 font-light max-w-sm leading-relaxed mx-auto">
                    Your metrics have been logged securely. The Hove Construction engineering division is reviewing your blueprint details and will schedule a consult call shortly.
                  </p>
                  <button
                    onClick={() => setIsSuccess(false)}
                    className="px-6 py-2.5 bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-orange-500 hover:text-orange-500 font-mono text-xs tracking-widest uppercase transition-all duration-300 cursor-pointer"
                  >

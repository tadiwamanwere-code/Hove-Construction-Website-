    ...
    >
      ...
      >
        <img
          ...
          alt="Hove Construction Luxury Architectural Build"
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 w-full text-left flex flex-col justify-center h-full">
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-xs md:text-sm font-mono tracking-[0.3em] text-orange-500 uppercase font-medium">
              {HERO_DATA.tagline}
            </span>
          </motion.div>
          ...
          >
            ...
            <button
              ...
              className="px-8 py-4 bg-white/5 hover:bg-white/10 text-white border border-white/20 hover:border-orange-500 hover:text-orange-500 font-mono text-xs tracking-widest uppercase transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center">
        <button
          ...
          className="text-gray-400 hover:text-orange-500 transition-colors duration-300 flex flex-col items-center gap-2 cursor-pointer"
        ...
        >
          ...
          <div className="h-10 w-[1px] bg-white/20 relative overflow-hidden">
            <motion.div
              ...
              className="absolute top-0 left-0 right-0 h-1/2 bg-orange-500"
            />
          </div>
        </button>
      </div>

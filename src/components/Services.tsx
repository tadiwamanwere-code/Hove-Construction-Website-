        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-6 border transition-all duration-300 relative group cursor-pointer ${
                    isExpanded
                      ? 'bg-white/5 border-orange-500/80 shadow-[0_4px_20px_rgba(234,88,12,0.15)]'
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className={`p-3 transition-colors duration-300 ${
                        isExpanded ? 'bg-orange-500/10' : 'bg-white/5'
                      }`}>
          ...
          <div className="lg:col-span-7 h-full flex flex-col justify-between">
            <div className="bg-[#121317] border border-white/5 p-8 md:p-12 min-h-[420px] flex flex-col justify-between relative group overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-orange-600/5 transform translate-x-12 -translate-y-12 rotate-45 pointer-events-none transition-transform duration-700 group-hover:scale-125" />
                    ...
                    >
                      <div>
                        <div className="flex items-center gap-3 mb-4">
                          <span className="px-2 py-0.5 bg-orange-500/10 text-orange-500 text-[10px] font-mono tracking-widest uppercase">
                            CORE METHOD
                          </span>
                      ...
                      <div className="border-t border-white/5 pt-6 mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <a
                          href="#contact"
                          className="text-xs font-mono text-orange-500 hover:text-white transition-colors flex items-center gap-2 group/btn"
                        >
